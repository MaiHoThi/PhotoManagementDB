...
<body>
    ...
    <form action="{{'photos/'.$edit->$id.'/update'}}" method="POST" role="form" enctype="multipart/form-data">
            @csrf
            ...
            <div class="form-group">
                ...
                <textarea type="text" value="" class="form-control" name="description"></textarea>
            </div>
